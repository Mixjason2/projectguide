...
type ExpandedJobDetailProps = {
  job: Job;
  jobs: Job[];
  expandedPNRs: Record<string, boolean>;
  renderPlaceDate: (place: string, date: string, label: string) => React.ReactNode;
...
// ประกาศแบบ named export
export const ExpandedJobDetail = ({
...
const confirme = Array.isArray(job.isConfirmed)
  ...
  : job.isConfirmed ?? false;  // ถ้าไม่ระบุ assume ไม่ confirmed
  return (
