...
export default function CssgGuide({ children }: { children: React.ReactNode }) {
    ...
    return (
        <>
            <header className="navbar bg-blue-500 py-8 px-12 text-3xl font-bold shadow-lg flex items-center justify-between">
                {/* Left: Hamburger */}
            ...
            {open && (
                <>
                    ...
                    <div
                        ...
                        className="fixed top-0 left-0 z-40 h-screen p-4 bg-blue-200 w-64 transition-transform flex flex-col justify-between"
                        tabIndex={-1}
                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                            <ul className="space-y-2 font-medium flex-1 flex flex-col overflow-y-auto">
                                ...
                                <li>
                                    <a href="/jobs" className="flex items-center p-4 text-lg font-semibold text-blue-900 rounded-xl hover:bg-blue-100 group">
                                        {/* Jobs List icon */}
                                        <svg className="w-8 h-8 text-blue-500 transition duration-75 group-hover:text-blue-900"
                                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                                            <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z" />
