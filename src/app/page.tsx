...
const countryMapping: Record<Region, CountryInfo> = {
  TH: { asmdb: "Assignment_TH", connection: "[AS-DTGTHA]" },
  MY: { asmdb: "Assignment_MY", connection: "[AS-DTGKUL]" },
  SL: { asmdb: "Assignment_SL", connection: "[AS-DTGSLK]" },
  SG: { asmdb: "Assignment_SG", connection: "[AS_DTGSIN]" },
  VN: { asmdb: "Assignment_VN", connection: "[AS-DTGVNM]" },
};
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { asmdb, connection } = countryMapping[selectedCountry];
