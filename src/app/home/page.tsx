    ...
    return (
      <div className="max-h-[60vh] overflow-auto">
        {Object.values(groupedJobs).map(({ job, typeNames }, idx) => (
          <div key={job.key + "-" + idx} className="mb-4 border-b border-blue-200 pb-2 last:border-b-0 last:pb-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-sm [&>div>span:first-child]:font-bold">
              ...
              <div className="flex flex-wrap">
                <span className="font-Arial w-28 shrink-0">Booking Consultant:</span>
                <span className="break-words ml-2">
            ...
            <thead className="bg-[#2D3E92] text-black">
              ...
              <div className="flex flex-wrap">
                <span className="font-Arial w-28 shrink-0">TypeName:</span>
                <span className="break-words ml-2">{[...new Set(typeNames)].join(", ")}</span>
              </div>
            </div>
          </div>
        ))}
