...
var Loading = function () { return (react_1["default"].createElement("div", { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', fontSize: '1.2rem', color: '#555' } },
    react_1["default"].createElement("div", { style: { display: 'flex', gap: 8, marginBottom: 12 } }, [0, 1, 2].map(function (i) { return (react_1["default"].createElement("span", { key: i, style: {
            width: 12,
            height: 12,
...
return (react_1["default"].createElement("div", { className: "max-w-4xl mx-auto p-4" },
    ...
    react_1["default"].createElement("div", { className: "flex gap-4 mb-4" },
        react_1["default"].createElement("div", null,
            react_1["default"].createElement("label", { className: "block text-sm" }, "Start date"),
            react_1["default"].createElement("input", { type: "date", value: startDate, onChange: function (e) { return setStartDate(e.target.value); }, className: "input input-bordered" })),
        react_1["default"].createElement("div", null,
            react_1["default"].createElement("label", { className: "block text-sm" }, "End date"),
            react_1["default"].createElement("input", { type: "date", value: endDate, onChange: function (e) { return setEndDate(e.target.value); }, className: "input input-bordered" }))),
    react_1["default"].createElement(react_2["default"], { plugins: [daygrid_1["default"], timegrid_1["default"], list_1["default"], interaction_1["default"]], initialView: "dayGridMonth", events: events, datesSet: function (arg) { return setCurrentView(arg.view.type); }, height: "auto", contentHeight: "auto", aspectRatio: 1.7, headerToolbar: {
            start: 'title',
