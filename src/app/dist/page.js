    ...
    return (React.createElement("div", { className: "min-h-screen flex items-center justify-center", style: { backgroundColor: "#2d4392" } },
        React.createElement("div", { className: "card w-full max-w-3xl bg-white shadow-xl rounded-xl relative overflow-hidden" },
            ...
            React.createElement("div", { className: "card-body relative z-10" },
                React.createElement("div", { className: "flex flex-col items-center  p-0 m-0 leading-none" },
                    React.createElement("h2", { className: "text-[4rem] font-extrabold flex p-0 m-0 leading-none" },
                        React.createElement("span", { className: "text-blue-900" }, "D"),
                        React.createElement("span", { className: "text-green-500" }, "T"),
                        React.createElement("span", { className: "text-teal-500" }, "H")),
                    React.createElement("div", { className: "relative flex flex-col items-center mt-[-4px]" },
                        React.createElement("div", { className: "absolute h-1 border-t-4 border-black top-[-0.5px] left-[0.1em] w-[3.2em]" }),
                        React.createElement("p", { className: "text-[2.2rem] font-bold uppercase m-0 p-0 leading-none tracking-wide" }, "TRAVEL")),
                    React.createElement("p", { className: "text-[1.25rem] font-bold uppercase m-0 p-0 leading-none -mt-1" }, "GUIDE PORTAL")),
