...
function CssgGuide(_a) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("header", { className: "navbar bg-base-300 py-8 px-12 text-3xl font-bold shadow-lg " },
            react_1["default"].createElement("div", { className: "flex-none" },
                react_1["default"].createElement("div", { className: "flex-none ml-auto" },
        ...
        open && (react_1["default"].createElement(react_1["default"].Fragment, null,
            ...
            react_1["default"].createElement("div", { id: "drawer-navigation", className: "fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto bg-white w-64 dark:bg-gray-800 transition-transform", tabIndex: -1, "aria-labelledby": "drawer-navigation-label" },
                ...
                react_1["default"].createElement("div", { className: "py-4 overflow-y-auto" },
                    react_1["default"].createElement("ul", { className: "space-y-2 font-medium" },
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement("a", { href: "#", className: "flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" },
                                ...
                                react_1["default"].createElement("span", { className: "ms-3" }, "Dashboard")))))))),
