...
function CssgGuide(_a) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("header", { className: "navbar bg-[#2D3E92] py-4 px-12 text-3xl font-bold shadow-lg flex items-center justify-between text-white" },
            ...
            react_1["default"].createElement("div", { className: "flex-none flex items-center" },
                react_1["default"].createElement("button", { className: "btn btn-square btn-ghost text-white" },
        ...
        open && (react_1["default"].createElement(react_1["default"].Fragment, null,
            ...
            react_1["default"].createElement("div", { id: "drawer-navigation", className: "fixed top-0 left-0 z-40 h-screen p-4 bg-[#2D3E92] w-64 transition-transform flex flex-col justify-between text-white", tabIndex: -1, "aria-labelledby": "drawer-navigation-label" },
                react_1["default"].createElement("h5", { id: "drawer-navigation-label", className: "text-base font-semibold uppercase" }, "Menu"),
                react_1["default"].createElement("button", { type: "button", "aria-controls": "drawer-navigation", className: "bg-transparent hover:bg-[#1f2b68] hover:text-white rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center", onClick: function () { return setOpen(false); } },
                ...
                react_1["default"].createElement("div", { className: "flex-1 flex flex-col justify-between" },
                    react_1["default"].createElement("ul", { className: "space-y-2 font-medium flex-1 flex flex-col overflow-y-auto" },
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement(link_1["default"], { href: "/calendar", className: "flex items-center p-4 text-lg font-semibold text-white rounded-xl hover:bg-[#1f2b68] group" },
                        ...
                        react_1["default"].createElement("li", null,
                            react_1["default"].createElement("a", { href: "/home", className: "flex items-center p-4 text-lg font-semibold text-white rounded-xl hover:bg-[#1f2b68] group" },
