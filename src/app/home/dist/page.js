        ...
        React.createElement("div", { className: "flex justify-center items-start py-8 min-h-screen bg-base-200" },
            React.createElement("div", { className: "bg-base-100 rounded-xl shadow-xl border border-base-300 w-full max-w-full p-0" },
                React.createElement("div", { className: "p-4 w-full min-h-screen overflow-auto" },
                    ...
                    React.createElement("div", { className: "mb-8 flex flex-col sm:flex-row gap-4 items-center justify-center" },
                        React.createElement("div", { className: "flex flex-col items-start" },
                            ...
                            React.createElement("input", { id: "start-date", type: "date", value: startDate, max: endDate, onChange: function (e) { return setStartDate(e.target.value); }, className: "input input-bordered w-44", placeholder: "Start date" })),
                        React.createElement("span", { className: "mx-2 mt-6 sm:mt-8 text-gray-400 font-semibold" }, "to"),
                        React.createElement("div", { className: "flex flex-col items-start" },
                            React.createElement("label", { className: "mb-1 text-xs text-gray-500 font-semibold", htmlFor: "end-date" }, "End date"),
                            React.createElement("input", { id: "end-date", type: "date", value: endDate, min: startDate, onChange: function (e) { return setEndDate(e.target.value); }, className: "input input-bordered w-44", placeholder: "End date" }))),
